...
class genetic:
    ...
    def Mutate(self,chromosome):
        ...
        if(self.Mutation_decrease):
            Mutation_rate_chromosome = self.Mutation_rate_chromosome *                                 ((self.Generation - self.current_generation -1 )/self.Generation)
        else:
    ...
    def train(self,):
        ...
        for self.current_generation in range(self.Generation):
            ...
            if(Generation_Score[self.current_generation-3:self.current_generation].sum() / 3 ==                                                       Generation_Score[self.current_generation]):
